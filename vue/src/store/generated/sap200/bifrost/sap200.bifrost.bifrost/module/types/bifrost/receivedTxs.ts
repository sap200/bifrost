...
export const ReceivedTxs = {
  encode(message: ReceivedTxs, writer: Writer = Writer.create()): Writer {
    if (message.creator !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): ReceivedTxs {
    ...
    const message = { ...baseReceivedTxs } as ReceivedTxs
