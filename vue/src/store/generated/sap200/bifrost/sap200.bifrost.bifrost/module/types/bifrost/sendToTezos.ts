...
const baseSendToTezos: object = { creator: '', id: 0, tezosReceiver: '', amount: '', denom: '' }

export const SendToTezos = {
  encode(message: SendToTezos, writer: Writer = Writer.create()): Writer {
    if (message.creator !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): SendToTezos {
    ...
    const message = { ...baseSendToTezos } as SendToTezos
