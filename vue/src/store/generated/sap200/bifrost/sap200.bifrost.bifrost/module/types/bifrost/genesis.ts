...
const baseGenesisState: object = { sendToTezosSignedCount: 0, receivedFa12TxsCount: 0, sendToTezosCount: 0, receivedTxsCount: 0 }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 7:
          ...
          break
        case 8:
          message.sendToTezosSignedCount = longToNumber(reader.uint64() as Long)
          break
        case 5:
          message.receivedFa12TxsList.push(ReceivedFa12Txs.decode(reader, reader.uint32()))
          break
        case 6:
          message.receivedFa12TxsCount = longToNumber(reader.uint64() as Long)
          break
        case 3:
          message.sendToTezosList.push(SendToTezos.decode(reader, reader.uint32()))
          break
        case 4:
          message.sendToTezosCount = longToNumber(reader.uint64() as Long)
          break
        case 1:
          message.receivedTxsList.push(ReceivedTxs.decode(reader, reader.uint32()))
          break
        case 2:
          message.receivedTxsCount = longToNumber(reader.uint64() as Long)
          break
        default:
