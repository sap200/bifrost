...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryReceivedFa12TxsAll = (query, params = {}) => this.request({
         ...
         */
        this.queryReceivedFa12Txs = (id, params = {}) => this.request({
         ...
         */
        this.queryReceivedTxsAll = (query, params = {}) => this.request({
         ...
         */
        this.queryReceivedTxs = (id, params = {}) => this.request({
         ...
         */
        this.querySendToTezosAll = (query, params = {}) => this.request({
         ...
         */
        this.querySendToTezos = (id, params = {}) => this.request({
         ...
         */
        this.querySendToTezosSignedAll = (query, params = {}) => this.request({
         ...
         */
        this.querySendToTezosSigned = (id, params = {}) => this.request({
